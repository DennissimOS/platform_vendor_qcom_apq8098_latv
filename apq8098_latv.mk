...
PRODUCT_COPY_FILES += \
    device/qcom/apq8098_latv/seccomp/mediacodec-seccomp.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediacodec.policy \
    device/qcom/apq8098_latv/seccomp/mediaextractor-seccomp.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediaextractor.policy
...
PRODUCT_NAME := apq8098_latv
PRODUCT_DEVICE := apq8098_latv
PRODUCT_BRAND := Android
PRODUCT_MODEL := apq8098_latv for arm64
...
PRODUCT_COPY_FILES += \
    device/qcom/apq8098_latv/vintf.xml:$(TARGET_COPY_OUT_VENDOR)/manifest.xml

# Audio configuration file
-include $(TOPDIR)hardware/qcom/audio/configs/apq8098_latv/apq8098_latv.mk
...
PRODUCT_COPY_FILES += \
    device/qcom/apq8098_latv/WCNSS_qcom_cfg.ini:system/etc/wifi/WCNSS_qcom_cfg.ini \
    device/qcom/apq8098_latv/wifi_concurrency_cfg.txt:system/etc/wifi/wifi_concurrency_cfg.txt
...
PRODUCT_COPY_FILES += \
device/qcom/apq8098_latv/powerhint.xml:system/etc/powerhint.xml
